<template>
  <div class="purchaseRecordList">
    <v-card>
      ...
      <v-card-text>
        <v-data-iterator :items="searchfilter" :items-per-page="itemsPerPage" :page="currentPage"
          ...
          <template v-slot:footer>
            <div class="d-flex justify-space-between align-center pa-4">
              <div class="d-flex align-center">
                ...
                <v-select v-model="itemsPerPage" :items="itemsPerPageOptions" item-title="title" item-value="value"
                  density="compact" hide-details></v-select>
              </div>

              <div class="d-flex align-center">
                <span class="mr-4">
                  {{ getDisplayRange() }} / {{ totalItems }}
                </span>

                <v-btn density="compact" icon :disabled="currentPage === 1" @click="currentPage = 1">
                  <v-icon>mdi-page-first</v-icon>
                </v-btn>

                <v-btn class="ml-1" density="compact" icon :disabled="currentPage === 1" @click="currentPage--">
                ...
                <v-btn density="compact" icon :disabled="currentPage === totalPages" @click="currentPage++">
                  <v-icon>mdi-chevron-right</v-icon>
                </v-btn>

                <v-btn class="ml-1" density="compact" icon :disabled="currentPage === totalPages"
...
// 分頁計算
const totalItems = computed(() => searchfilter.value.length);
